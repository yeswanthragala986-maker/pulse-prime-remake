  ...
  head: () => ({
    meta: [
      ...
      { title: "Cybersecurity Club — Think. Hack. Defend." },
      {
        name: "description",
        content:
          "Official cybersecurity club building the next generation of digital defenders through CTFs, labs and research.",
      },
      { property: "og:site_name", content: "Cybersecurity Club" },
